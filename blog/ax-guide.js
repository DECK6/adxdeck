...
const AX_TOPICS = Object.freeze([
    ...
    },
    {
        ...
        slugs: ['managing-document-lifecycles-before-rag-retrieval', 'agent-experience-becomes-knowledge-when-it-transfers', 'agent-knowledge-management', 'retrieval-chunks-should-keep-document-context', 'knowledge-graphs-need-an-evidence-contract', 'missing-data-is-not-false-shacl-validation-boundaries', 'hipporag-two-and-associative-retrieval', 'portable-ai-knowledge-with-okf-provenance-and-verification', 'ontology-competency-questions-as-a-work-contract', 'retrieved-documents-are-data-not-instructions']
    },
    {
        ...
        slugs: ['drawing-approval-boundaries-before-agent-automation', 'when-agent-loops-need-control-graphs', 'agent-retries-need-idempotency-and-receipts', 'designing-reliable-multi-agent-fan-in', 'can-a-long-running-agent-survive-a-code-change', 'should-agent-traces-record-everything']
    },
    {
