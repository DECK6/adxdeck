...
type: article
track: ai-ax
title: "AI 업무를 배포하기 전에 작은 평가 사례집부터 만드는 법"
description: "대표 사례와 경계 사례, 실패 사례를 작은 평가 사례집으로 묶어 AI 업무의 배포 범위와 검증 기준을 정하는 방법을 살펴본다."
aliases:
  - "building-a-small-evaluation-set-before-ai-deployment"
author:
  - "육대근"
...
tags:
  ...
  - ai-ax
  - evaluation
thumbnail: images/gpt2-building-a-small-evaluation-set-before-ai-deployment.png
status: completed
publishReady: true
---
...
![서로 다른 형태와 재질의 작은 조각을 나란히 놓아 평가 사례의 다양성을 표현한 개념 이미지](images/gpt2-building-a-small-evaluation-set-before-ai-deployment.png)
...
배포 전 평가는 거대한 벤치마크를 만드는 일로 오해되기 쉽다. 그래서 데이터가 많아질 때까지 미루거나, 몇 개 결과를 함께 보고 느낌으로 결정한다. 그러나 작은 업무에서는 수십만 건의 시험보다 **서로 다른 실패를 대표하는 사례와 명시적인 판정 기준**이 먼저 필요하다. 평가 사례집은 모델의 지능 점수를 매기는 시험지가 아니라, 이 업무에서 무엇을 통과로 볼지 팀이 합의하는 작업 문서다.
...
[8] [OpenAI API — Evaluation best practices](https://developers.openai.com/api/docs/guides/evaluation-best-practices)
[9] [OpenAI API — Getting started with datasets](https://developers.openai.com/api/docs/guides/evaluation-getting-started)
