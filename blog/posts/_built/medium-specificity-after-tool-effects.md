---
type: article
title: "도구 목록만으로는 작품이 되지 않는다"
aliases:
  - "Medium Specificity After Tool Effects"
author:
  - "[[육대근]]"
...
tags:
  ...
  - AI
  - installation
description: "매체 특정성은 순수한 장르로 돌아가자는 말이 아니라, 장비·소프트웨어·데이터·공간·관객 조건이 작품을 어떻게 필연적으로 조직하는지 묻는 비평 언어다."
thumbnail: images/medium-specificity-after-tool-effects-cover.png
status: completed
---
# 도구 목록만으로는 작품이 되지 않는다

![매체 특정성을 설명하는 장치와 공간의 구성](images/medium-specificity-after-tool-effects-cover.png)
