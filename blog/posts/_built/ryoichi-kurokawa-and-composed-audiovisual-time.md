...
title: "쿠로카와 료이치의 시간 조각은 어떻게 전시되는가"
aliases:
  - "Ryoichi Kurokawa and Composed Audiovisual Time"
author:
  - "육대근"
...
tags:
  ...
  - time-sculpture
  - art-science
description: "쿠로카와 료이치의 《Rheo》와 《unfold》를 통해 공연의 시간과 반복 설치의 시간을 비교한다. 천체물리 데이터를 소리·영상·진동으로 옮기는 과정에서 과학적 근거와 예술적 구성을 구분하고, 오디오비주얼 작품의 전시·기록 조건을 살핀다."
thumbnail: images/ryoichi-kurokawa-and-composed-audiovisual-time-cover.png
status: completed
---

# 쿠로카와 료이치의 시간 조각은 어떻게 전시되는가

![분리된 빛의 면과 입자 구름, 진동을 암시하는 굴곡으로 시청각 시간의 구성을 표현한 추상 개념 이미지](images/ryoichi-kurokawa-and-composed-audiovisual-time-cover.png)
...
- [1] Ryoichi Kurokawa, [Biography](https://www.ryoichikurokawa.com/bio.html).
- [2] Ryoichi Kurokawa, [《Rheo》](https://www.ryoichikurokawa.com/project/rheo.html).
- [3] Ryoichi Kurokawa, [《unfold》](https://www.ryoichikurokawa.com/project/unfold.html).
- [4] FACT, [《unfold (2016)》](https://www.fact.co.uk/artwork/unfold-2016).
