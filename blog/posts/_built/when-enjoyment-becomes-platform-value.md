...
tags:
  ...
  - AI
  - creative-labor
description: "프리 레이버 개념을 통해 자발적인 창작과 참여가 어떻게 플랫폼의 데이터·운영·평판 자산으로 전환되는지 살피고, 미디어아트와 AI 공동체가 기여의 권리와 보상을 다시 설계하는 기준을 제안한다."
thumbnail: images/free-labor-platform-value-cover.png
status: completed
---

# 좋아서 한 일이 플랫폼의 자산이 될 때

![자발적 참여의 빛이 중앙의 구조에 비대칭적으로 축적되는 미디어아트 설치 장면](images/free-labor-platform-value-cover.png)
