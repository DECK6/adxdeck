---
type: article
title: "아카이브는 보관이 아니라 작동이다"
aliases:
  - "The Archive Is an Operation"
author:
  - "[[Deck]]"
...
tags:
  ...
  - archive
  - time
description: "An essay on Wolfgang Ernst's media archaeology: why the archive must be read as a technical operation of addressing, replay, and machine time rather than as a cultural site of memory, and what that shift means for sound, signal, and contemporary media art."
thumbnail: images/2026-05-12-archive-as-operation-cover.png
status: completed
---

# 아카이브는 보관이 아니라 작동이다

![cover](images/2026-05-12-archive-as-operation-cover.png)

볼프강 에른스트(Wolfgang Ernst)를 단순히 “아카이브의 이론가”로 부르는 것은 절반만 맞는다. 그가 한 일은 우리가 ‘아카이브’라는 말에서 떠올리는 풍경 — 먼지 쌓인 서고, 보존되는 문서, 인간이 다시 읽을 미래의 기억 — 을 흔드는 일이다. 에른스트의 질문은 더 차갑다. 무엇이 보존되는가가 아니라, 어떻게 주소가 붙고, 어떤 클록으로 재생되며, 어떤 신호 처리 위에서 다시 호출 가능한가. 아카이브는 보관소가 아니라 하나의 작동이다.
...
이 차이는 단순한 강조점 이동이 아니다. 매체를 ‘무엇을 말하는가’의 층위에서 읽는 한, 우리는 늘 의미 해석학으로 회귀한다. 그러나 매체를 ‘어떻게 작동하는가’의 층위에서 읽기 시작하면, 매체는 더 이상 메시지의 그릇이 아니다. 매체는 시간을 자르고 반복하고 재생하는 기계다. 에른스트가 *Chronopoetics*에서 끈질기게 강조하는 것이 이것이다. 기계는 시간을 재현하지 않는다. 기계는 시간을 생산한다.
...
사운드아트가 에른스트와 특히 잘 만나는 이유도 같다. 소리는 이미지보다 더 직접적으로 시간을 다룬다. 반복, 지연, 진동, 샘플의 미세한 틱은 서사 이전에 시간 구조를 노출한다. 그래서 그의 *Sonic Time Machines*는 음악 이론서가 아니라 시간의 기술적 분석서로 읽히는 편이 더 정확하다.
