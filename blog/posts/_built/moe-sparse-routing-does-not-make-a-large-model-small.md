...
type: article
track: ai-ax
title: "MoE의 활성 파라미터만 보면 배포 비용을 놓친다"
description: "Mixture-of-Experts 모델이 일부 전문가만 계산하는 원리와 전체 가중치 메모리, 전문가 간 통신, 부하 쏠림을 분리해 실제 업무 도입 기준을 살펴본다."
aliases:
  - "MoE의 활성 파라미터만 보면 배포 비용을 놓친다"
  - "MoE Sparse Routing Does Not Make a Large Model Small"
author:
  - 육대근
...
tags:
  ...
  - expert-routing
  - workload-evaluation
thumbnail: images/moe-sparse-routing-does-not-make-a-large-model-small-cover.png
status: completed
---

# MoE의 활성 파라미터만 보면 배포 비용을 놓친다

![원형으로 배치된 많은 전문가 모듈 가운데 일부만 토큰 경로를 따라 빛나는 추상 개념 이미지](images/moe-sparse-routing-does-not-make-a-large-model-small-cover.png)
...
- DeepSeek-AI, [DeepSeek-V3 Technical Report v2](https://arxiv.org/html/2412.19437v2), 2025-02-18.
- vLLM, [Expert Parallel Deployment](https://docs.vllm.ai/en/latest/serving/expert_parallel_deployment), accessed 2026-09-22. 최신 개발 문서이며 옵션과 기본값은 버전에 따라 달라질 수 있다.
- William Fedus, Barret Zoph, Noam Shazeer, [Switch Transformers: Scaling to Trillion Parameter Models with Simple and Efficient Sparsity](https://jmlr.org/papers/v23/21-0998.html), JMLR 23(120), 2022. 2021년 연구 계보를 설명하는 기반 자료다.
