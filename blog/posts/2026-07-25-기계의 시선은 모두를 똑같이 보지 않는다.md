...
tags:
  ...
  - facial-analysis
  - AI
description: "조이 부올라미니의 Gender Shades와 예술 실천을 통해 평균 정확도가 가리는 얼굴 분석의 격차, 알고리즘 감사의 공적 역할, 더 정확한 감시가 답이 아닐 수 있는 이유를 살핀다."
thumbnail: images/machine-vision-does-not-see-everyone-equally-cover.png
status: completed
---

# 기계의 시선은 모두를 똑같이 보지 않는다

![서로 다른 재질의 추상 두상 사이로 푸른 스캔 광선이 지나가고 한 형상만 주황 윤곽으로 다르게 감지되는 설치 장면](images/machine-vision-does-not-see-everyone-equally-cover.png)
...
부올라미니와 팀닛 게브루가 2018년에 발표한 [《Gender Shades》 논문](https://proceedings.mlr.press/v81/buolamwini18a.html)은 상용 얼굴 분석 서비스 세 개의 젠더 분류 성능을 피부 유형과 젠더 집단별로 나누어 평가했다. 밝은 피부 남성 집단의 최대 오류율은 0.8%였지만, 어두운 피부 여성 집단에서는 오류율이 최대 34.7%까지 올라갔다. 전체 평균만 보면 사라질 수 있는 차이다.
...
부올라미니가 세운 [Algorithmic Justice League](https://www.ajl.org/about)는 연구, 예술, 교육과 정책 개입을 같은 활동 안에 둔다. 여기서 감사는 기술팀 내부의 품질 점검으로 끝나지 않는다. 측정 결과를 공개하고, 영향을 받는 사람의 경험과 연결하며, 기업과 공공기관이 답하도록 만드는 사회적 절차가 된다.
...
이 글은 [MIT Media Lab의 Gender Shades 프로젝트 설명](https://www.media.mit.edu/projects/gender-shades/overview/), 부올라미니와 게브루의 2018년 논문, Algorithmic Justice League의 공식 소개를 바탕으로 썼다.
