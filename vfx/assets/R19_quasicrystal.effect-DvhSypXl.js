function r(e){const a=String(e??"#5EE7F3").replace("#",""),t=/^[0-9a-f]{6}$/i.test(a)?a:"5EE7F3";return[0,2,4].map(o=>Number.parseInt(t.slice(o,o+2),16)/255)}const u={kind:"webgl",shader:{frag:`
...
`,uniforms:e=>({u_fps:e.fps,u_seed:e.random("shader-seed")*4096,u_symmetry:Math.min(9,Math.max(5,Number(e.params.symmetry??5))),u_frequency:Math.min(30,Math.max(8,Number(e.params.frequency??17))),u_contrast:Math.min(1.6,Math.max(.4,Number(e.params.contrast??1.05))),u_speed:Math.min(3,Math.max(1,Math.round(Number(e.params.speed??1)))),u_signal:r(e.params.signal)})}};export{u as default};
