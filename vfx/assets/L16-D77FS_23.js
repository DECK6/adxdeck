...
var L16_disco_ball_effect_exports = {};
__export(L16_disco_ball_effect_exports, {
  default: () => L16_disco_ball_effect_default
});
module.exports = __toCommonJS(L16_disco_ball_effect_exports);
const TAU = Math.PI * 2;
const kernel = {
  kind: "canvas",
  draw: (g, ctx) => {
    ...
    for (let row = 0; row < facets; row += 1) {
      for (let column = 0; column < facets; column += 1) {
        ...
        const glint = Math.sin(column * 1.71 + row * 2.37 - phase * 2) * 0.5 + 0.5;
...
var L16_disco_ball_effect_default = kernel;
`;export{n as default};
