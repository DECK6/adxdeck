function u(e){const a=String(e??"#5EE7F3").replace("#",""),o=/^[0-9a-f]{6}$/i.test(a)?a:"5EE7F3";return[0,2,4].map(t=>Number.parseInt(o.slice(t,t+2),16)/255)}const n={kind:"webgl",shader:{frag:`
...
`,uniforms:e=>({u_bands:Math.min(12,Math.max(4,Math.round(Number(e.params.bands??8)))),u_speed:Math.min(4,Math.max(1,Math.round(Number(e.params.speed??2)))),u_contrast:Math.min(2,Math.max(.6,Number(e.params.contrast??1.25))),u_signal:u(e.params.signal)})}};export{n as default};
