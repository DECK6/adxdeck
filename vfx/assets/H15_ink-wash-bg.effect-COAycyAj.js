function r(e){const a=String(e??"#5EE7F3").replace("#",""),o=/^[0-9a-f]{6}$/i.test(a)?a:"5EE7F3";return[0,2,4].map(l=>Number.parseInt(o.slice(l,l+2),16)/255)}const s={kind:"webgl",shader:{frag:`
...
`,uniforms:e=>({u_resolution:[e.width,e.height],u_frame:e.frame,u_t:e.t,u_fps:e.fps,u_seed:e.random("ink-wash-seed"),u_scale:Math.min(6,Math.max(1.5,Number(e.params.scale??3.2))),u_bleed:Math.min(1,Math.max(.2,Number(e.params.bleed??.7))),u_layers:Math.min(6,Math.max(2,Math.round(Number(e.params.layers??4)))),u_signal:r(e.params.signal)})}};export{s as default};
