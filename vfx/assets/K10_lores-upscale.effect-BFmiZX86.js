function l(e){const a=String(e??"#5EE7F3").replace("#",""),t=/^[0-9a-f]{6}$/i.test(a)?a:"5EE7F3";return[0,2,4].map(o=>Number.parseInt(t.slice(o,o+2),16)/255)}const u={kind:"webgl",shader:{frag:`
...
`,uniforms:e=>({u_pixelSize:Math.min(24,Math.max(3,Math.round(Number(e.params.pixelSize??11)))),u_interpolation:Math.min(1,Math.max(0,Number(e.params.interpolation??.18))),u_scanlines:Math.min(1,Math.max(0,Number(e.params.scanlines??.72))),u_signal:l(e.params.signal)})}};export{u as default};
