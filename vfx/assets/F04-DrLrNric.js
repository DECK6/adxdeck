...
var F04_projector_flicker_effect_exports = {};
__export(F04_projector_flicker_effect_exports, {
  default: () => F04_projector_flicker_effect_default
});
module.exports = __toCommonJS(F04_projector_flicker_effect_exports);
const kernel = {
  kind: "canvas",
  stateful: {
    init: (ctx) => {
    ...
    render: (g, state, ctx) => {
      ...
      const gateRotation = weave * Math.sin(phase * 5) * 55e-4;
      const overscan = 12;
      g.fillStyle = "#0D0E10";
...
var F04_projector_flicker_effect_default = kernel;
`;export{t as default};
