...
var Z07_teletext_effect_exports = {};
__export(Z07_teletext_effect_exports, {
  default: () => Z07_teletext_effect_default
});
module.exports = __toCommonJS(Z07_teletext_effect_exports);
const kernel = {
  kind: "canvas",
  draw: (g, ctx) => {
...
var Z07_teletext_effect_default = kernel;
`;export{n as default};
