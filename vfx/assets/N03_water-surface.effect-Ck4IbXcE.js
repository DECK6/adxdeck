function c(a){const e=String(a??"#5EE7F3").replace("#",""),u=/^[0-9a-f]{6}$/i.test(e)?e:"5EE7F3";return[0,2,4].map(o=>Number.parseInt(u.slice(o,o+2),16)/255)}const t={kind:"webgl",shader:{frag:`
...
`,uniforms:a=>({u_amplitude:Math.min(.08,Math.max(0,Number(a.params.amplitude??.026))),u_frequency:Math.min(10,Math.max(2,Number(a.params.frequency??5.4))),u_caustics:Math.min(1,Math.max(0,Number(a.params.caustics??.62))),u_signal:c(a.params.signal)})}};export{t as default};
