...
var U02_toggle_switch_effect_exports = {};
__export(U02_toggle_switch_effect_exports, {
  default: () => U02_toggle_switch_effect_default
});
module.exports = __toCommonJS(U02_toggle_switch_effect_exports);
const TAU = Math.PI * 2;
const kernel = {
  kind: "react",
  render: (ctx) => {
    ...
    const position = forward / Math.max(1e-4, forward + reverse);
    ...
    return /* @__PURE__ */ h("div", { style: { position: "absolute", inset: 0, overflow: "hidden", background: "#0D0E10" } }, /* @__PURE__ */ h(
      ...
      ctx.subjectNode
    ), [1.42, 1.2].map((ringScale, index) => /* @__PURE__ */ h(
      "div",
      {
        key: ringScale,
        style: {
...
var U02_toggle_switch_effect_default = kernel;
`;export{n as default};
