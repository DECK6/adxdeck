function o(e){const a=String(e??"#5EE7F3").replace("#",""),s=/^[0-9a-f]{6}$/i.test(a)?a:"5EE7F3";return[0,2,4].map(r=>Number.parseInt(s.slice(r,r+2),16)/255)}const u={kind:"webgl",shader:{frag:`
...
`,uniforms:e=>({u_spread:Number(e.params.spread??1),u_feather:Number(e.params.feather??.075),u_fibers:Number(e.params.fibers??5),u_seed:e.random("ink-bleed")*97,u_signal:o(e.params.signal)})}};export{u as default};
