function i(a){const e=String(a??"#5EE7F3").replace("#",""),t=/^[0-9a-f]{6}$/i.test(e)?e:"5EE7F3";return[0,2,4].map(o=>Number.parseInt(t.slice(o,o+2),16)/255)}const u={kind:"webgl",shader:{frag:`
...
`,uniforms:a=>{const e=String(a.params.count??"6");return{u_ballCount:e==="4"?4:e==="8"?8:6,u_radius:Math.min(.28,Math.max(.08,Number(a.params.radius??.16))),u_softness:Math.min(.24,Math.max(.02,Number(a.params.softness??.09))),u_refraction:Math.min(.08,Math.max(0,Number(a.params.refraction??.024))),u_signal:i(a.params.signal)}}}};export{u as default};
